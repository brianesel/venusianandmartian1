...
class App extends React.Component {
  ...
  setAnimation(newAnimation, speed) {
    ...
    if (newAnimation === "typing" || newAnimation === "stressed") {
      clearTimeout(this.loopRef);
      requestAnimationFrame(this.loop);
      document.querySelector('#myface').style = 'transition: all 0.3s ease;top:65px;';
    } else {
      document.querySelector('#myface').style = 'transition: all 0.3s ease;top:50px;left: 81px;transform: rotate(-36deg);';
    }
    if (newAnimation === "passive") {

    } else if (newAnimation === "waiting") {

    } else if (newAnimation === "thinking") {
      document.querySelector('#myface').style = 'transition: all 0.3s ease;top:50px;left: 37px;transform: rotate(-60deg);';
    } else if (newAnimation === "stressed") {
      document.querySelector('#myface').style = 'transition: all 0.3s ease;top:79px;left: 37px;transform: rotate(-88deg);';
    }
  }
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("h3", { id: "title" }, "In side the Martian Unicorn home"), /*#__PURE__*/
      ...
      React.createElement("img", { id: "myface", src: "https://i.ibb.co/4g1KsXF/D7-AB88-AB-7253-497-E-8103-0319374-EEB18-removebg-preview.png", alt: "D7-AB88-AB-7253-497-E-8103-0319374-EEB18-removebg-preview", border: "0" }), /*#__PURE__*/
